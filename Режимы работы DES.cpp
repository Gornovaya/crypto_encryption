...
const int IP1[8][8]					//матрица начальной перестановки
{
...
const int IP2[8][8]					//матрица обратной перестановки
{
...
const int E[8][6]					//функция расширения
{
	{32,1,2,3,4,5},
	{4,5,6,7,8,9},
	{8,9,10,11,12,13},
...
const int P[8][4]					//Функция перестановки
{
	{16,7,20,21},
	{29,12,28,17},
	{1,15,23,26},
...
const int G[8][7]					//матрица первоначальной подготовки ключа
{
	{57,49,41,33,25,17,9},
	{1,58,50,42,34,26,18},
	{10,2,59,51,43,35,27},
...
const int SHIFT[16]					//Таблица сдвигов для вычисления ключа
{ 1,1,2,2,2,2,2,2,1,2,2,2,2,2,2,1 };

const int H[8][6]					//матрица завершающей обработки ключа
{
	{14,17,11,24,1,5},
	{3,28,15,6,21,10},
	{23,19,12,4,26,8},
...
std::vector<int> DES(std::vector<int> encrypted, 
	std::vector<int> key, int round, bool flag);									//Раунд шифрования DES
